...
tab2_outter_panel.add(new Ext.form.field.Text({id:"id-001",fieldLabel:'Name'}));


var subpanel1={xtype:'panel',title:'panel-sub1',height:100,width:'10%',collapsed: true};
var subpanel2={xtype:'panel',title:'panel-sub2',height:100,width:'10%',collapsed: false};
var subpanel3={xtype:'panel',title:'panel-sub3',height:100,width:'10%',  collapsed: true};
